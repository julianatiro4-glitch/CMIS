<?php $__env->startSection('title', $asset->asset_tag); ?>
    ...
    <div class="flex items-start gap-3">
        ...
        <div>
            <div class="flex flex-wrap items-center gap-2">
                ...
                <span class="px-2.5 py-1 rounded-full text-xs font-bold <?php echo e($conditionColors[$asset->condition] ?? 'bg-slate-100 text-slate-500'); ?>">
                    <?php echo e(ucfirst(str_replace('_', ' ', $asset->condition))); ?>

                </span>
                <?php endif; ?>
            </div>
            <h2 class="text-lg font-bold text-slate-800 mt-1"><?php echo e($asset->name); ?></h2>

        </div>
    </div>
    <div class="flex flex-wrap gap-2 flex-shrink-0">
        <a href="<?php echo e(route('assets.label', $asset)); ?>" target="_blank"
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="lg:col-span-2 space-y-5">
            ...
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="bg-slate-50 rounded-xl p-4">
                    ...
                    <p class="text-sm font-semibold text-slate-800">
                        <?php echo e($asset->ram_total ?: '—'); ?>

                        <?php if($asset->ram_used): ?>
                            <span class="text-xs font-normal text-slate-400 ml-1">(<?php echo e($asset->ram_used); ?> used)</span>
                        <?php endif; ?>
                    </p>
                </div>
                ...
                <div class="bg-slate-50 rounded-xl p-4">
                    ...
                    <p class="text-sm font-semibold text-slate-800"><?php echo e($asset->storage_capacity ?: '—'); ?></p>
                </div>
                ...
                <div class="bg-slate-50 rounded-xl p-4 sm:col-span-2">
                    ...
                    <p class="text-sm font-semibold text-slate-800"><?php echo e($asset->operating_system ?: '—'); ?></p>
                </div>


                <div class="bg-slate-50 rounded-xl p-4 flex items-center gap-3">
                    <div class="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 <?php echo e($asset->has_crowdstrike ? 'bg-green-100' : 'bg-slate-100'); ?>">
                        <svg class="w-4 h-4 <?php echo e($asset->has_crowdstrike ? 'text-green-600' : 'text-slate-400'); ?>"
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold <?php echo e($asset->has_crowdstrike ? 'text-green-600' : 'text-slate-500'); ?>">
                            <?php echo e($asset->has_crowdstrike ? 'Installed' : 'Not Installed'); ?>

                        </p>
                    </div>
                </div>

                <?php if($asset->software_installed): ?>
                <div class="bg-slate-50 rounded-xl p-4 sm:col-span-2">
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wide mb-1">Software Installed</p>
                    <p class="text-sm text-slate-700 leading-relaxed"><?php echo e($asset->software_installed); ?></p>
                </div>
                <?php endif; ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="bg-slate-50 rounded-xl p-4">
                    ...
                    <?php if($asset->division): ?>
                        <span class="inline-block font-mono font-bold text-blue-700 bg-blue-50 border border-blue-100 px-2 py-0.5 rounded text-xs mb-1">
                            <?php echo e($asset->division->code); ?>

                        </span>
                        <p class="text-sm font-semibold text-slate-800"><?php echo e($asset->division->name); ?></p>
                    <?php else: ?>
                ...
                <div class="bg-slate-50 rounded-xl p-4">
                    ...
                    <p class="text-sm font-semibold text-slate-800"><?php echo e($asset->utilized_by ?: '—'); ?></p>
                </div>
                ...
                <div class="bg-slate-50 rounded-xl p-4">
                    ...
                    <p class="text-sm font-semibold text-slate-800">
                        <?php echo e(strtoupper($asset->connectivity ?? 'LAN')); ?>

                        <?php if($asset->wifi_network): ?>
                            <span class="text-slate-400 text-xs font-normal ml-1">(<?php echo e($asset->wifi_network); ?>)</span>
                        <?php endif; ?>
                    </p>
                </div>
                ...
                <div class="bg-slate-50 rounded-xl p-4">
                    ...
                    <p class="text-sm font-semibold text-slate-800">
                        <?php echo e(ucfirst(str_replace('_', ' ', $asset->ownership_type ?? 'office_owned'))); ?>
        ...
        <?php if($asset->notes || $asset->specifications): ?>
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-5">
            <h3 class="font-bold text-slate-800 text-sm mb-3">Notes & Remarks</h3>
            <?php if($asset->notes): ?>
            <p class="text-sm text-slate-600 leading-relaxed"><?php echo e($asset->notes); ?></p>
            <?php endif; ?>
            <?php if($asset->specifications): ?>
            <p class="text-sm text-slate-600 leading-relaxed mt-2"><?php echo e($asset->specifications); ?></p>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-5 space-y-3">
                <div>
                    ...
                    <p class="text-sm font-semibold text-slate-800 mt-0.5"><?php echo e($asset->category?->name ?? '—'); ?></p>
                </div>

                <div>
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wide">Serial Number</p>
                    <p class="text-sm font-mono font-semibold text-slate-800 mt-0.5"><?php echo e($asset->serial_number ?? '—'); ?></p>
                </div>
                <div>
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wide">Condition</p>
                    <span class="inline-block mt-0.5 px-2.5 py-1 rounded-full text-xs font-bold <?php echo e($conditionColors[$asset->condition ?? 'good'] ?? 'bg-slate-100 text-slate-500'); ?>">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-5">
            ...
            <div class="space-y-2">
                <div>
                    ...
                    <p class="text-xs text-slate-600 mt-0.5"><?php echo e($asset->created_at->format('M d, Y H:i')); ?></p>
                </div>
                <div>
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wide">Last Updated</p>
                    <p class="text-xs text-slate-600 mt-0.5"><?php echo e($asset->updated_at->format('M d, Y H:i')); ?></p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JulianaTiro\cmis\resources\views/assets/show.blade.php ENDPATH**/ ?>