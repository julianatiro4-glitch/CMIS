<?php $__env->startSection('title', 'Edit Technical Support Ticket'); ?>
<?php $__env->startSection('subtitle', 'Update technical support ticket information'); ?>
...
<div class="max-w-xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow border border-slate-100 p-6">
        <form action="<?php echo e(route('technical_support.update', $record)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="date" id="date" 
                       value="<?php echo e(old('date', $record->date->format('Y-m-d\TH:i'))); ?>" 
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = ['PED', 'LMISD', 'Admin', 'SPD', 'OPM', 'LRSD', 'DOC', 'MSD']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $div): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($div); ?>" <?php echo e(old('division', $record->division) == $div ? 'selected' : ''); ?>><?php echo e($div); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="reported_by" id="reported_by" placeholder="e.g. Mam Ara" 
                       value="<?php echo e(old('reported_by', $record->reported_by)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="handled_by" id="handled_by" placeholder="Technician name" 
                       value="<?php echo e(old('handled_by', $record->handled_by)); ?>"
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <option value="for_checking" <?php echo e(old('status', $record->status) == 'for_checking' ? 'selected' : ''); ?>>For Checking</option>
                    <option value="failed" <?php echo e(old('status', $record->status) == 'failed' ? 'selected' : ''); ?>>Failed</option>
                    <option value="done" <?php echo e(old('status', $record->status) == 'done' ? 'selected' : ''); ?>>Done</option>
                </select>
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('issue_problem', $record->issue_problem)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('action_taken', $record->action_taken)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JulianaTiro\cmis\resources\views/technical_support/edit.blade.php ENDPATH**/ ?>