...
@section('title', 'New Division / Section')
@section('subtitle', 'Add a new division or section under a location')
...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-lg font-bold text-slate-800">New Division / Section</h2>
    </div>

    <form method="POST" action="{{ route('divisions.store') }}" class="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
        @csrf
        ...
        <div class="flex gap-3 mt-6 pt-4 border-t border-slate-100">
            <button class="px-5 py-2 text-sm font-semibold text-white rounded-lg hover:opacity-90 transition-all"
                    style="background:#0d2a5e;">Save Division</button>
